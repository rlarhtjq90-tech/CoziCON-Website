...
export default async function AppHeader({ userId, userEmail, companyName }: Props) {
    ...
    <header className="bg-white border-b border-ink-200 shadow-sm">
      <div className="container-content flex items-center justify-between h-16">
        ...
        <div className="flex items-center gap-4">
          {companyName && (
            <span className="text-p14 font-semibold text-ink-700 hidden sm:block">{companyName}</span>
          )}
