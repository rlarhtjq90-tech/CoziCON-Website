...
const FAQS = [
  {
    q: 'CastBid은 무료로 사용할 수 있나요?',
    a: '네, 현재 CastBid은 종합건설사·전문건설사 모두 무료로 가입하고 이용할 수 있습니다. 향후 고급 분석·우선 노출 등 유료 기능이 추가될 수 있으나, 핵심 입찰 기능은 무료로 유지됩니다.',
  },
  {
  ...
  },
  {
    ...
    a: '플랫폼에 기록된 입찰 내역, Q&A, 계약서 등을 근거로 당사자 간 협의를 먼저 권장합니다. 협의가 어려운 경우, 전자상거래 분쟁조정위원회 또는 대한상사중재원에 조정을 신청할 수 있으며, CastBid은 관련 기록을 제공하는 방식으로 지원합니다.',
  },
]
